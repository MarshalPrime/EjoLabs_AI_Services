...
```mermaid
graph TD
    A[Software Foundations] -->|Git, APIs, DBs| B[AI Applications]
    B -->|Prompts, RAG, Agents| C[Production Systems]
    C -->|Evaluation, Security, Cost| D[DevOps & Cloud]
    D -->|Docker, CI/CD, Cloud Run| E[Product & Pitch]
    E -->|SWOT, Demos, Launch| F[Demo Day]
    style A fill:#f9f9f9,stroke:#1A2535,stroke-width:2px
    style B fill:#f9f9f9,stroke:#1A2535,stroke-width:2px
    style C fill:#f9f9f9,stroke:#1A2535,stroke-width:2px
    style D fill:#f9f9f9,stroke:#1A2535,stroke-width:2px
    style E fill:#FEF9F4,stroke:#E87722,stroke-width:2px
    style F fill:#E87722,stroke:#fff,stroke-width:2px,color:#fff
```
